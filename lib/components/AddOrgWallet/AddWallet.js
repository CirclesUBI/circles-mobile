            ...
            <View style={{
              ...
              <View
                ...
                <Text style={{fontFamily: fonts.boldText, color: 'white', fontSize: 16}}>
                  1. {translate('Create an organizational wallet*')}
                </Text>
                <Image
                  style={{
              ...
              <Text
                style={{
                  ...
                  marginTop: 15}}
              >
                {translate('This secondary wallet will not receive a basic income and is only visible to you or administrators that you add.')}
              </Text>
              <View style={{
