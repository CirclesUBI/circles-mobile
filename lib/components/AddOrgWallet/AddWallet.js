      ...
      <View style={{flex: 1, backgroundColor: darkBackground}}>
        ...
        <View style={{flex: 1, justifyContent: 'space-between'}}>
          <View style={{alignItems: 'center'}}>
            <View style={{height: calculateHeightRatio(194), width: calculateWidthRatio(338.8), borderWidth: 1, borderColor: '#252635', justifyContent: 'center'}}>
              <View style={{flexDirection: 'row', alignItems: 'center', justifyContent: 'flex-start', alignSelf: 'flex-start', marginLeft: calculateWidthRatio(12)}}>
              ...
              <Text style={{fontFamily: 'now-alt-regular', color: '#CECECE', fontSize: 12, marginLeft: calculateWidthRatio(12), marginRight: calculateWidthRatio(87.8), marginTop: 15}}>
