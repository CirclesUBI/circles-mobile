        ...
        <View
          ...
          <TouchableHighlight style={{
            ...
            <View style={{flexDirection: 'row', marginLeft: 21, alignItems: 'center'}}>
              ...
              <Text style={{fontFamily: fonts.primaryText, color: 'white', marginLeft: 16}}>{translate('Back')}</Text>
            </View>
          </TouchableHighlight>
          <TouchableHighlight style={{
            alignItems: 'center',
              ...
              <View style={{width: calculateWidthRatio(285), alignSelf: 'center', marginTop: 30}}>
                <View style={{
                  ...
                  <Text style={{fontFamily: fonts.boldText, color: 'white', fontSize: 16}}>
                    2. {translate('Trading goods and services')}
                  </Text>
                  <Image style={{
                ...
                <Text style={{
                  ...
                  marginTop: 15}}
                >
                  {translate('Please enter information about what you are offering in exchange for Circles. This information will be displayed in the app when people search for organizations.')}
                </Text>
              </View>
