...
import { primary, background5, background3, fonts } from 'circles-mobile/lib/styles/styles'
            ...
            <View style={{
              ...
              <View style={{width: calculateWidthRatio(285), alignSelf: 'center', marginTop: 30}}>
                ...
                <Text style={{
                  ...
                  marginTop: 15}}
                >
                  Please enter information about what you are offering in exchange for Circles.
                  This information will be displayed in the app when people search for organizations.
                </Text>
              </View>
