          ...
          <View style={{flexDirection: 'row', justifyContent: 'space-between', marginRight: 15, marginTop: 10, marginLeft: 15}}>
            ...
            <TouchableHighlight onPress={() => {
              ...
              <View style={{flexDirection: 'row', alignItems: 'center'}}>
                ...
                <Image style={{height: calculateHeightRatio(29), width: calculateWidthRatio(9), marginLeft: calculateWidthRatio(9), resizeMode: 'contain'}} source={require('circles-mobile/images/circleArrowRight.png')} />
              </View>
            </TouchableHighlight>
          </View>
        </View>
