              ...
              <View style={{
                ...
                <View style={{
                  ...
                  <Text style={{fontFamily: fonts.boldText, color: 'white', fontSize: 16}}>
                    3. {translate('Add Administrators')}
                  </Text>
                  <Image
                    style={{
                ...
                <Text style={{
                  ...
                  marginTop: 15}}>
                  {translate("Adding administrators allows them to request and make payments, and see this organizational wallet's transaction history.")}
                </Text>
              </View>
