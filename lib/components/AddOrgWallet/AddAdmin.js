...
const ViewRow = (props) => (
  <View style={{height: calculateHeightRatio(50), flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', borderBottomWidth: 1, borderColor: '#272838'}}>
    <Text style={{marginLeft: 17, fontFamily: 'now-alt-regular', fontSize: 12, color: 'white'}}>{props.name}</Text>
    <TouchableHighlight>
      <View style={{width: calculateWidthRatio(112), height: calculateHeightRatio(35), backgroundColor: '#FFAE00', borderRadius: 6, alignItems: 'center', justifyContent: 'center', marginRight: 10}}>
    ...
    return (
      <View style={{flex: 1, backgroundColor: darkBackground}}>
        ...
        <View style={{flexDirection: 'row', height: calculateHeightRatio(61), alignItems: 'center'}}>
          ...
          <Image style={{height: calculateHeightRatio(18), width: calculateWidthRatio(10), marginLeft: calculateWidthRatio(15)}} source={require('circles-mobile/images/arrowRight.png')} />
        </View>
        <View style={{flex: 1, justifyContent: 'space-between', marginBottom: 15}}>
          <View style={{alignItems: 'center'}}>
            <View style={{width: calculateWidthRatio(338.8), height: calculateHeightRatio(502), borderWidth: 1, borderColor: '#252635'}}>
              <View style={{width: calculateWidthRatio(295), alignSelf: 'center', marginTop: 30, marginBottom: 30}}>
                <View style={{flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', alignSelf: 'flex-start'}}>
                  ...
                  <Image style={{height: calculateHeightRatio(10), width: calculateWidthRatio(18), marginLeft: calculateWidthRatio(11)}} source={require('circles-mobile/images/arrowDown.png')} />
                </View>
              ...
              <View style={{height: calculateHeightRatio(95), borderTopWidth: 1, borderColor: '#252635'}}>
                <Text style={{fontFamily: 'now-alt-regular', fontSize: 14, color: 'white', marginLeft: 20, marginTop: 15}}>CONTACTS</Text>
                <View style={{
          ...
          <View style={{flexDirection: 'row', justifyContent: 'space-between', marginRight: 15, marginTop: 10, marginLeft: 15}}>
            ...
            <TouchableHighlight onPress={() => {
              ...
              <View style={{flexDirection: 'row', alignItems: 'center'}}>
                ...
                <Image style={{height: calculateHeightRatio(29), width: calculateWidthRatio(29), marginLeft: calculateWidthRatio(9)}} source={require('circles-mobile/images/circleArrowRight.png')} />
              </View>
            </TouchableHighlight>
          </View>
        </View>
