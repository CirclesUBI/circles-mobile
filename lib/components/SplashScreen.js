...
import { primary, secondary, width, height, fonts } from 'circles-mobile/lib/styles'
        ...
        >
          ...
          { _.isEmpty(this.props.wallets)
            ? (<View style={{flex: 0.25, flexDirection: 'row'}}>
              <TouchableHighlight style={[styles.loginButton, {backgroundColor: secondary, width: width}]} onPress={() => {
