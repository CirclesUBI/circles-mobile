      ...
      <View style={{flex: 1, backgroundColor: darkBackground}}>
        ...
        <View style={{flex: 1, alignItems: 'center', justifyContent: 'space-between'}}>
          <View style={{flex: 1, alignItems: 'center'}}>
            <Text style={{fontFamily: 'now-alt-bold', fontSize: 20, color: 'white', marginTop: 50}}>
            ...
            <View style={{
              ...
              />
              <Text style={{color: '#FFFFFF', fontSize: 60, textAlign: 'center', fontFamily: 'ostrich-sans-heavy', marginTop: 10}}>
                {` CCS`}
              </Text>
            </View>
          </View>
