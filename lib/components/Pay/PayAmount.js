      ...
      <View style={{flex: 1, backgroundColor: darkBackground}}>
        ...
        <View style={{flex: 1, alignItems: 'center', justifyContent: 'space-between'}}>
          <View style={{flex: 1, alignItems: 'center'}}>
            <Text style={{fontFamily: 'now-alt-bold', fontSize: 20, color: 'white', marginTop: 50}}>From: Ashoka Finley</Text>
          ...
          <KeyboardAvoidingView style={{height: calculateHeightRatio(56)}}>
            <TouchableHighlight onPress={() => this.props.navigation.navigate('PayContacts', {screen: 'PayConfirm'})}>
