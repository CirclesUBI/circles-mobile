...
import { View, Text, TextInput, TouchableHighlight, KeyboardAvoidingView, Alert, connect } from 'react-native'
      ...
      <View style={{flex: 1, backgroundColor: '#161724'}}>
        ...
        <View style={{flex: 1, alignItems: 'center', justifyContent: 'space-between'}}>
          <View style={{alignItems: 'center'}}>
            <Text style={{fontFamily: 'now-alt-bold', fontSize: 20, color: 'white', marginTop: calculateHeightRatio(50)}}>From: Ashoka Finley</Text>
          ...
          <KeyboardAvoidingView style={{height: calculateHeightRatio(56)}}>
            <TouchableHighlight onPress={() => {
              Alert.alert(
                'Are you sure you want to pay Ed Murphy 50 CCS?',
                '',
              [
