...
import { Text, TouchableHighlight, View, Image, FlatList, TouchableWithoutFeedback } from 'react-native'
import { SegmentedControl } from 'antd-mobile-rn'
import { calculateWidthRatio, calculateHeightRatio } from 'circles-mobile/lib/utilities/sizingHelper'
import { primary, textColorMain, lightBackground, mediumBackground, mediumLightBackground } from 'circles-mobile/lib/styles/styles'
  ...
  render () {
    ...
    return (
      <View style={{flex: 1, backgroundColor: mediumBackground}}>
        ...
        <View style={{flex: this.state.renderSuggestion ? 0.45 : 0.62}}>
          {
        ...
        {this.state.renderSuggestion
          ? (<View style={{flex: 0.17, backgroundColor: lightBackground}}>
            ...
            <TouchableWithoutFeedback onPress={() => this.setState({renderSuggestion: false})}>
        ...
        { this.props.user.validated
            ? <ActionButtons single navigation={this.props.navigation} />
