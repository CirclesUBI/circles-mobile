...
import { Text, TouchableHighlight, View, Image, StyleSheet, FlatList } from 'react-native'
import { SegmentedControl } from 'antd-mobile-rn'
import { calculateWidthRatio, calculateHeightRatio } from 'circles-mobile/lib/utilities/sizingHelper'
import { primary, secondary, textColorMain, lightBackground } from 'circles-mobile/lib/styles/styles'
        ...
        <View style={{flex: 0.45}}>
          {
            ...
            ? <View style={{justifyContent: 'center', alignItems: 'center'}}>
              <View style={{flexDirection: 'row', justifyContent: 'center', alignItems: 'center', marginTop: 35}}>
                <Image style={{width: calculateWidthRatio(37), height: calculateHeightRatio(37), resizeMode: 'contain'}} source={require('circles-mobile/images/circlesDistribution.png')} />
            ...
            : <FlatList
              ...
              renderItem={({item}) => <View style={{flexDirection: 'row', justifyContent: 'flex-start', alignItems: 'center', height: calculateHeightRatio(52), borderBottomWidth: 1, borderColor: 'rgba(58, 59, 78, 49)'}}>
                <Image style={{width: calculateWidthRatio(26), height: calculateHeightRatio(26), marginLeft: 27, resizeMode: 'contain'}} source={require('circles-mobile/images/circlesDistribution.png')} />
