...
import { primary, background5, background4, background1, textColor3, textColor4 } from 'circles-mobile/lib/styles/styles'
      ...
      <View style={{flexDirection: 'column'}}>
          ...
          <Menu style={{marginRight: 18}}>
            ...
            <MenuOptions customStyles={{optionsContainer: {marginTop: 30, borderBottomLeftRadius: 6, borderBottomRightRadius: 6, borderTopLeftRadius: 6}}}>
              ...
              <MenuOption onSelect={() => props.navigation.navigate('addOrgWallet.AddWallet')}>
                <Text style={{color: textColor3, fontSize: 14, fontFamily: 'now-alt-regular'}}>
                  ⨁ Add Org Wallet
                </Text>
              </MenuOption>
            </MenuOptions>
        ...
        <View style={{
          ...
          <View style={{flexDirection: 'column', marginLeft: 20}}>
            ...
            <Text style={{color: textColor4, fontSize: 14, fontFamily: 'now-alt-regular'}}>
              Circles
            </Text>
          </View>
          <TouchableHighlight style={{
