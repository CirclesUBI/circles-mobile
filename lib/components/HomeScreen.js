...
import { primary, darkBackground, mediumBackground, lightBackground, textColorSecondary, textColorTertiary } from 'circles-mobile/lib/styles/styles'
      ...
      <View style={{height: 201}}>
        <ImageBackground style={{height: calculateHeightRatio(201), width: calculateWidthRatio(327)}} source={item.thumb}>
          <View style={{flex: 1, justifyContent: 'flex-end'}}>
            <Text style={{fontFamily: 'ostrich-sans-heavy', color: 'white', fontSize: 20, marginLeft: 15, marginBottom: 5}}>
              {item.name}
            </Text>
          </View>
        </ImageBackground>
      ...
      <View style={{flexDirection: 'column'}}>
          ...
          <Menu style={{marginRight: 18}}>
            ...
            <MenuOptions customStyles={{optionsContainer: {marginTop: 30, borderBottomLeftRadius: 6, borderBottomRightRadius: 6, borderTopLeftRadius: 6}}}>
              ...
              <MenuOption onSelect={() => props.navigation.navigate('addOrgWallet.AddWallet')}>
                <Text style={{color: textColorSecondary, fontSize: 14, fontFamily: 'now-alt-regular'}}>
                  ⨁ Add Org Wallet
                </Text>
              </MenuOption>
            </MenuOptions>
        ...
        <View style={{
          ...
          <View style={{flexDirection: 'column', marginLeft: 20}}>
            ...
            <Text style={{color: textColorTertiary, fontSize: 14, fontFamily: 'now-alt-regular'}}>
              Circles
            </Text>
          </View>
          <TouchableHighlight style={{
