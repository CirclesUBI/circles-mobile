        ...
        <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
          <View style={{flex: 1, alignItems: 'center', justifyContent: 'space-between'}}>
            <View style={{flex: 1, alignItems: 'center'}}>
              <Text style={{fontFamily: fonts.boldText, fontSize: 20, color: 'white', marginTop: 50}}>{this.props.selectedWallet}</Text>
              <Text style={{fontFamily: fonts.primaryText, fontSize: 20, color: '#5D5D6A', marginTop: 10}}>{this.translate('Requests')}</Text>
              <View style={{width: calculateWidthRatio(170), borderColor: '#2E2F42', borderBottomWidth: 4, alignItems: 'center', justifyContent: 'center', marginTop: 40, flexDirection: 'row'}}>
                <TextInput
                  style={{color: '#FFFFFF', fontSize: 60, fontFamily: fonts.titleText, textAlign: 'right', marginLeft: 5}}
                ...
                />
                <Text style={{color: '#FFFFFF', fontSize: 60, textAlign: 'center', fontFamily: fonts.titleText, marginTop: 10}}>CCS</Text>
              </View>
            </View>
            <KeyboardAvoidingView style={{height: calculateHeightRatio(56)}}>
              <TouchableHighlight onPress={() => this.props.navigation.navigate('RequestQR', {amount: this.state.text, wallet: this.props.selectedWallet})}>
