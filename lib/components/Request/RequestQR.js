...
class RequestQR extends React.Component {
  render () {    
    var query = {amount: this.props.navigation.state.params.amount, address: this.props.navigation.state.params.wallet}
    var QRCodeUri = 'https://bwipjs-api.metafloor.com/?bcid=azteccode&text=' + query
    console.log(query)
    return (
