...
class ContactsScreen extends React.Component {
  ...
  handleChange (value) {
    this.setState({text: value, contacts: value ? _.filter(this.state.saveContacts, (i) => i.name.indexOf(value) > -1) : this.state.saveContacts})
  }
  ...
  async fetchContactsAsync () {
    ...
    if (contacts.total > 0) {
      this.setState({contacts: contacts.data, saveContacts: contacts.data})
  //     Alert.alert(
