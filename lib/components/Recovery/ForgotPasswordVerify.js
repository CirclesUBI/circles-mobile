...
export class ForgotPasswordVerify extends React.Component {
  ...
  componentDidMount () {
    // let signUpDetails = {
    //   name: this.props.recoveryData.name,
    //   username: this.props.recoveryData.username,
    //   phone: this.props.recoveryData.phone,
    //   email: this.props.recoveryData.email,
    //   picture: this.props.recoveryData.picture && this.props.recoveryData.picture.uri,
    //   password: this.props.recoveryData.password // hash this
    // }
  ...
  render () {
    ...
    //   this.props.recoveryData.phone,
    //   this.props.recoveryData.country
    // )
