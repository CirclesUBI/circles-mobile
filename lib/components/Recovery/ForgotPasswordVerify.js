        ...
        <LinearGradient colors={[secondary, '#160111']} style={{ flex: 1, width: width }}>
          ...
          <View style={{ flex: 1 }}>
            <View>
              ...
              >
                {this.translate('ENTER {codeType} CODE', {codeType: this.props.recoveryData.DeliveryMedium})}
              </Text>
              <Text
                style={{
                  textAlign: 'center',
              ...
              >
                {this.translate('We have sent a {codeType} code to', {codeType: this.props.recoveryData.DeliveryMedium})}
              </Text>
              <Text
                style={{
                  textAlign: 'center',
...
ForgotPasswordVerify.contextTypes = {
