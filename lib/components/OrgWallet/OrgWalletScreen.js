...
import { Dimensions, Text, TouchableHighlight, View, TouchableWithoutFeedback, Image, FlatList, ScrollView } from 'react-native'
      ...
      <View style={{flex: 1, backgroundColor: '#161724'}}>
        <View style={{flex: 0.22, backgroundColor: '#232436', shadowColor: '#000000', shadowOffset: {width: 0, height: 3}}}>
          <View style={{flex: 1, flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginTop: 25, marginLeft: 23, marginRight: 23}}>
            ...
            <Text style={{textAlign: 'center', color: 'white', fontSize: 20, fontFamily: 'now-alt-bold'}}>{this.state.walletName}</Text>
            <TouchableHighlight style={{alignItems: 'center', justifyContent: 'center', height: 35, width: 35}} onPress={() => {
          ...
          <Text style={{textAlign: 'center', justifyContent: 'center', alignItems: 'center', fontFamily: 'now-alt-regular', fontSize: 12, color: '#CECECE', marginBottom: 10}}>Account Value: 20000 CCS</Text>
          <SegmentedControl
        ...
        <View style={{flex: 0.45}}>
          {
            ...
            ? <ScrollView contentContainerStyle={{alignItems: 'center'}}>
              <View style={{flexDirection: 'row', justifyContent: 'center', alignItems: 'center', marginTop: 35, maxWidth: calculateWidthRatio(326), height: calculateHeightRatio(76), backgroundColor: '#232436', borderRadius: 7}}>
