...
import { primary, background4, background3 } from 'circles-mobile/lib/styles/styles'
        ...
        <View style={{flex: 0.45}}>
          {
            ...
            : <FlatList
              ...
              renderItem={({item}) => <View style={{
                ...
                <Text style={{marginLeft: 19, fontSize: 12, fontFamily: 'now-alt-regular', color: '#CECECE'}}>
