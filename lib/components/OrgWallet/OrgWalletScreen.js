      ...
      <View style={{flex: 1, backgroundColor: background4}}>
        <View style={{
          ...
          <Text style={{
            ...
            {`Account Value: ${numberWithCommas(this.props.wallets[this.props.user.selectedWallet].balance)} CCS`}
          </Text>
          <SegmentedControl
              ...
              ? <ScrollView contentContainerStyle={{alignItems: 'center'}}>
                <View
                  style={{
                    ...
                    alignItems: 'center',
                    marginTop: 35,
                    maxWidth: calculateWidthRatio(326),
                ...
                >
                  <View style={{flexDirection: 'row', justifyContent: 'center', alignItems: 'center', margin: 20}}>
                    <Image
                      style={{
                        width: calculateWidthRatio(30),
                        height: calculateHeightRatio(30),
                        resizeMode: 'contain',
                        marginLeft: 10
                      }}
                    ...
                    <Text style={{
                      ...
                      Yarn, Inc. has sent you a trust request!
                    </Text>
                  </View>
                </View>
                <View style={{
                  ...
                  <View style={{flexDirection: 'row', justifyContent: 'center', alignItems: 'center', margin: 20}}>
                    ...
                    <Text style={{
                      ...
                      fontFamily: fonts.primaryText,
                      color: 'white'
                    }}>Saraswathi Subbaraman has sent you a trust request!</Text>
                  </View>
                </View>
              </ScrollView>
              : <FlatList
                data={this.props.wallets[this.props.user.selectedWallet].transactions}
                renderItem={({item}, i) => <View key={i} style={{
                  flexDirection: 'row',
                  ...
                  <Image
                    ...
                    source={require('circles-mobile/images/userIcon.png')} />
                  <Text style={{marginLeft: 19, fontSize: 12, fontFamily: fonts.primaryText, color: '#CECECE'}}>
                    {`You ${item.type === 'request' ? 'received' : 'sent'} ${item.amount} CCS ${item.type === 'request' ? 'from' : 'to'} ${item.source}`}
                  </Text>
                </View>}
              />
          }
