    ...
    return (
      <View style={{ flex: 1, backgroundColor: background4 }}>
        ...
        >
          ...
          >
            {`Account Value: ${numberWithCommas(
              this.props.wallets[this.props.user.selectedWallet].balance
            )} CCS`}
          </Text>
          <SegmentedControl
            ...
            tintColor={primary}
            selectedIndex={
              typeof this.state.controlIndex !== "undefined"
        ...
        <View style={{ flex: 0.45 }}>
          {this.state.controlIndex ? (
            <ScrollView contentContainerStyle={{ alignItems: "center" }}>
              ...
              >
                ...
                >
                  ...
                  >
                    Saraswathi Subbaraman has sent you a trust request!
                  </Text>
                </View>
              </View>
            </ScrollView>
            ...
            <FlatList
              data={
                this.props.wallets[this.props.user.selectedWallet].transactions
              }
              ...
              renderItem={({ item }, i) => (
                ...
                >
                  ...
                  >
                    {`You ${item.type === "request" ? "received" : "sent"} ${
                      item.amount
                    } CCS ${item.type === "request" ? "from" : "to"} ${
                      item.source
                    }`}
                  </Text>
                </View>
