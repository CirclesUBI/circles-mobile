...
import { Dimensions, Text, TouchableHighlight, View, Image, StyleSheet, FlatList, ScrollView } from 'react-native'
import { SegmentedControl } from 'antd-mobile-rn'
import { calculateWidthRatio, calculateHeightRatio } from 'circles-mobile/lib/utilities/sizingHelper'
import { primary, secondary, textColorMain, lightBackground, mediumLightBackground, darkBackground } from 'circles-mobile/lib/styles/styles'

const Header = (props) => (
  <View style={{borderRadius: 3, backgroundColor: mediumLightBackground, width: calculateWidthRatio(346), height: calculateHeightRatio(32), justifyContent: 'center', marginTop: 12, marginBottom: 10, alignSelf: 'center'}}>
...
const Entry = (props) => (
  <View style={{height: calculateHeightRatio(60), width: calculateWidthRatio(247)}}>
  ...
  <View style={{flex: 1, backgroundColor: darkBackground}}>
      ...
      <View
        ...
        <TouchableHighlight style={{alignItems: 'center', justifyContent: 'center', height: 20, marginTop: 10}} onPress={() => {
          ...
          <View style={{flexDirection: 'row', alignItems: 'center', marginRight: 15}}>
            ...
            <Image style={{width: calculateWidthRatio(23), height: calculateHeightRatio(21), resizeMode: 'contain'}} source={require('circles-mobile/images/editing.png')} />
          </View>
        </TouchableHighlight>
      </View>
    ...
    <View style={{flex: 1, flexDirection: 'column', justifyContent: 'space-between'}}>
      <View style={{alignItems: 'center'}}>
        ...
        <Entry heading={'Name'} name={'Knitted Socks'} />
