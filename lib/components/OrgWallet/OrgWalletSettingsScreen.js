...
import { primary, background3, background5, fonts } from 'circles-mobile/lib/styles/styles'
...
const OrgWalletSettings = (props) => (
  <View style={{flex: 1, backgroundColor: background5}}>
    <View
      ...
      <View
        ...
        >
          <View style={{flexDirection: 'row', alignItems: 'center', marginRight: 15}}>
            <Text style={{fontFamily: fonts.primaryText, color: 'white', marginRight: 10}}>{`Edit`}</Text>
            <Image
      ...
      <Text style={{fontFamily: fonts.boldText, fontSize: 20, color: 'white', textAlign: 'center'}}>Settings</Text>
    </View>
