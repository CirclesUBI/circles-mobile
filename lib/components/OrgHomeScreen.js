...
import { primary, background5, background4, background1, fonts } from 'circles-mobile/lib/styles/styles'
  ...
  return (
    <View style={{flex: 1, backgroundColor: background4}}>
          ...
          <Menu style={{marginRight: 18}}>
            <MenuTrigger>
              <View style={{flexDirection: 'row', alignItems: 'center'}}>
                <Text style={{color: 'white', fontSize: 20, fontFamily: fonts.boldText, marginRight: 13}}>{props.user.selectedOrgWallet}</Text>
            ...
            <MenuOptions customStyles={{optionsContainer: {marginTop: 30}}}>
              <MenuOption onSelect={() => props.navigation.navigate('HomeScreen')}>
                <Text style={{fontSize: 20, fontFamily: fonts.primaryText}}>{props.user.name}</Text>
              </MenuOption>
              {wallets}
      ...
      <View style={{flex: 0.08, alignItems: 'center', flexDirection: 'row'}}>
        <Text style={{fontFamily: fonts.primaryText, fontSize: 14, color: '#FFFFFF', alignItems: 'center', justifyContent: 'center', marginTop: 2, marginLeft: 21}}>SHORTCUTS</Text>
          ...
          : (
            <View>
              <View style={{backgroundColor: background5, width: calculateWidthRatio(345), height: calculateHeightRatio(39), borderRadius: 6, justifyContent: 'center', alignSelf: 'center'}}>
                <Text style={{color: 'white', fontFamily: fonts.primaryText, fontSize: 12, marginLeft: 12}}>Trading in Person?</Text>
              </View>
              ...
              <View style={{marginTop: 16, backgroundColor: background5, width: calculateWidthRatio(345), height: calculateHeightRatio(39), borderRadius: 6, justifyContent: 'center', alignSelf: 'center'}}>
                <Text style={{color: 'white', fontFamily: fonts.primaryText, fontSize: 12, marginLeft: 12}}>Trading online?</Text>
              </View>
              <View style={{alignItems: 'center'}}>
                <Text style={{fontFamily: fonts.boldText, fontSize: 16, width: calculateWidthRatio(303), color: 'white', marginTop: 25}}>
