...
import { setVerificationState, createCirclesPerson } from '../../actions/OnboardingActions'
...
export class OnboardingVerifyPhone extends React.Component {
  constructor (props) {
    ...
    this.textInputsRefs = []
    this.createCirclesPerson = this.createCirclesPerson.bind(this)
  }
  ...
  async createCirclesPerson (name) {
    let randomWallet = ethers.Wallet.createRandom()
    let err = await SecureStore.setItemAsync('wallet', JSON.stringify(randomWallet))
    if (!err) {
...
export const mapDispatchToProps = dispatch => {
  return {
    ...
    createCirclesPerson: (address, signedTx) => {
      dispatch(createCirclesPerson(address, signedTx))
    }
