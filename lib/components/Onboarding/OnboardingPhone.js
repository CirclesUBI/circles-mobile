...
export class OnboardingPhone extends React.Component {
  ...
  onProcess () {
    ...
    if ((this.state.phone && this.state.phone.length < 10) || !PhoneNumberUtil.isViablePhoneNumber(this.state.phone)) {
      ...
      Alert.alert(
        'Phone Not Valid',
        "Please enter your full phone number starting with '00' and your international dialling code",
        [
  ...
  render () {
    ...
    // // let phoneNumber
    // let formattedPhone
    // formattedPhone = this.state.phone && this.state.phone.length > 4 && PhoneNumberUtil.isViablePhoneNumber(this.state.phone)
