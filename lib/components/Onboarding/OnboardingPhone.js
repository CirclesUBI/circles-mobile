...
class OnboardingPhone extends React.Component {
    ...
    return (
      <OnboardingScreenComponent
        ...
        main={<OnboardingTextInput
          ...
          placeholder={'+1 (888) 888-8888'} //todo: we display the relevant placeholder based on the locale
        ...
        footer={
          <View>
            ...
            <Text style={{
              ...
              {this.translate('We will be sending this number a SMS to confirm your account')}
            </Text>
          </View>
        }
      />
