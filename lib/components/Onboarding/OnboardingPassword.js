          ...
          <View style={{ flex: 1 }}>
            ...
            <Text style={{
              ...
              {this.state.passwordStrength.uppercase &&
                ...
                ? translate('Password is sufficiently strong')
                : translate('Password must contain at least:')
              }
            </Text>
            {
              this.state.passwordStrength.uppercase
                ? null
                : <PasswordCheck
                  check={translate('1 uppercase letter')}
                />
            }
            {
              this.state.passwordStrength.lowercase
                ? null
                : <PasswordCheck
                  check={translate('1 lowercase letter')}
                />
            }
            {
              this.state.passwordStrength.digit
            ...
            }
            {
              this.state.passwordStrength.special
                ? null
                : <PasswordCheck
                  check={translate('1 special character')}
                />
            }
            {
              this.state.passwordStrength.length
                ? null
                : <PasswordCheck
                  check={translate('At least 8 characters')}
                />
            }
          </View>
        }
