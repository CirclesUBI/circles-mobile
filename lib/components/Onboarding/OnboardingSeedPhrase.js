...
class OnboardingSeedPhrase extends React.Component {
      ...
      <OnboardingScreenComponent
        ...
        main={
          <View style={{ flex: 1 }}>
            ...
            >
              {this.translate('SAVE YOUR 12 WORD SEED PHRASE')}
            </Text>
            <Text
              style={{
                textAlign: 'center',
            ...
            >
              {this.translate('This is the only way to recover your account -- save this somewhere where only you can find it.')}
            </Text>
