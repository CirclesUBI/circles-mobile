...
class SplashContainer extends React.Component {
  constructor (props, {t: translate}) {
    ...
    this.handleNewPhoneButton = this.handleNewPhoneButton.bind(this)
  }
        ...
        <LinearGradient colors={[secondary, '#160111']} style={{ flex: 1 }}>
          ...
          <View style={{ flex: 1 }}>
            ...
            >
              ...
              <LoginTextInput
                placeholder={this.translate('Enter your mobile number')}
                label={this.translate('Mobile Number')}
                value={this.state.username}
                onChangeText={value => this.handleUsernameChange(value)}
              />
              <LoginTextLabel label={this.translate('PASSWORD')} />
              <LoginTextInput
                placeholder={this.translate('Enter your password')}
          ...
          <View style={{ flex: 0.5 }}>
            ...
            <View style={{ flex: 1, justifyContent: 'space-around', flexDirection: 'row'}}>
              <TouchableHighlight onPress={this.handleNewPhoneButton}>
                <Text style={{
                  color: 'white',
                  fontSize: 16,
                  fontFamily: fonts.primaryText,
              ...
              <TouchableHighlight onPress={this.handleForgotButton}>
                <Text style={{
                  ...
                  marginTop: 18,
                  marginBottom: 8
                }}>{this.translate('Forgot Password?')}</Text>
              </TouchableHighlight>
            </View>
          </View>
        </LinearGradient>
