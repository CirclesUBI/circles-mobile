      ...
      <OnboardingScreenComponent
        ...
        main={
          <View style={{ flex: 1 }}>
            ...
            >
              {this.translate('CONFIRM YOUR 12 WORD SEED PHRASE')}
            </Text>
            <Text
              style={{
                textAlign: 'center',
            ...
            >
              {this.translate('Select the seed words in the order that you received them. This is the only way to recover your account - save this somewhere where only you can find it.')}
            </Text>
