        ...
        <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
          <View style={{flex: 1, flexDirection: 'column', alignItems: 'center'}}>
            ...
            <Text style={{color: 'white', textAlign: 'center', fontFamily: fonts.primaryText, width: calculateWidthRatio(260), marginTop: calculateHeightRatio(21)}}>
              {translate('Validation is a way to prove your identity, extending your ability to transact with individuals and organizations.')} <Text style={{fontFamily: fonts.primaryText, color: '#FFAE00'}}>{translate('Contact the validator to get your code.')}</Text>
            </Text>
