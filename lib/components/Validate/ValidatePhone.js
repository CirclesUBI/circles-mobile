...
import { validateUser } from 'circles-mobile/lib/actions/UserActions'
        ...
        <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
          <View style={{flex: 1, flexDirection: 'column', alignItems: 'center'}}>
            ...
            <Text style={{color: 'white', textAlign: 'center', fontFamily: fonts.primaryText, width: calculateWidthRatio(260), marginTop: calculateHeightRatio(21)}}>
              Validation is a way to prove your identity, extending your ability to transact with individuals and organizations. <Text style={{fontFamily: fonts.primaryText, color: '#FFAE00'}}>Contact the validator to get your code.</Text>
            </Text>
...
const mapDispatchToProps = (dispatch) => {
  return {
    validatedUser: () => dispatch(validateUser())
  }
}
