...
import { secondary } from 'circles-mobile/lib/styles'
...
const NavBar = (props) => <View
  ...
  {props.noBack
    ...
    : <TouchableHighlight
      style={{ alignItems: 'center', justifyContent: 'center', height: 20, minWidth: calculateWidthRatio(56) }}
      onPress={props.navFunction}
    >
      <View style={{ flexDirection: 'row', alignItems: 'center' }}>
        <Image style={{ width: calculateWidthRatio(10), height: calculateHeightRatio(18), resizeMode: 'contain' }}
  ...
  {props.noClose
    ? <View style={{ height: 20, minWidth: calculateWidthRatio(56) }} />
    : <TouchableHighlight style={{ alignItems: 'center', justifyContent: 'center', height: 20, minWidth: calculateWidthRatio(56) }}
