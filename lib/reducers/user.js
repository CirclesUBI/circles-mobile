...
export default function userReducer (state = initialState, action) {
  switch (action.type) {
    ...
    case ADD_DATA:
      return Object.assign({}, state, {name: action.data.name, phone: action.data.phone, email: action.data.email, photoUrl: action.data.photoUrl, isSignedIn: action.data.isSignedIn, selectedWallet: action.data.name})
    default:
      return state
  }
}
