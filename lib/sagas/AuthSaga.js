...
import { SIGNIN_REQUEST, SIGNOUT_REQUEST, SIGNUP_REQUEST, SIGNUP_CONFIRM_REQUEST, INIT_FORGOT_PASSWORD, CONFIRM_FORGOT_PASSWORD, CHECK_USERNAME_EXISTS, INIT_RECOVER_ACCOUNT } from 'circles-mobile/lib/constants/AuthConstants'
...
export function * initRecoverAccount () {
  while (true) {
    ...
    try {
      ...
      let response = yield API.post('users', '/recover', myInit)
