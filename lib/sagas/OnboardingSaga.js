...
import { FETCH_CURRENT_COUNTRY, SIGN_UP } from 'circles-mobile/lib/constants/OnboardingConstants'
// import {
...
export function * signUp (action) {
  try {
    ...
    yield put(addData({name: action.loginDetails.name, phone: action.loginDetails.phone}))
  } catch (err) {
    console.log(err)
    if (err.code === 'UsernameExistsException') {
      ...
      if (response.constructor.name === 'CognitoUser') {
        yield put(addData({phone: action.loginDetails.phone, isSignedIn: true}))
